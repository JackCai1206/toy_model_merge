"""Lightweight character-level tokenizer for the string composition tasks."""
...
class SimpleCharTokenizer(PreTrainedTokenizer):
    """Minimal character-level tokenizer tailored to the string tasks."""

    def __init__(
        self,
        extra_chars: Iterable[str] | None = None,
